...
final class StoreStandaloneSplitBillPlanRequest extends ApiRequest
{
    public function rules(): array
    {
        return [
            'qr_session_id' => ['required', 'string', 'max:100'],
            ...
            'participants' => [
                ...
                'array',
                'min:2',
                'max:'.(string) config('dine_in.split_bill.max_participants', 12),
            ],
